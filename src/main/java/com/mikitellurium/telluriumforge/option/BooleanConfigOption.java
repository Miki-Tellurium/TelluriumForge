 ...
 * {@code BooleanConfigOption} is specifically designed to work with {@link NumberConfigEntry}
 * for boolean values.
 */
public class BooleanConfigOption extends ConfigOption<Boolean> {
    ...
    /**
     * Constructs a {@link ConfigOption} for the given {@link NumberConfigEntry}
     * of type boolean.
     ...
     * @param config       The boolean {@link NumberConfigEntry} associated with the option
     */
    public BooleanConfigOption(Identifier identifier, String enabledKey, String disabledKey, BooleanConfigEntry config) {
     ...
     * @param config     The boolean {@link NumberConfigEntry} associated with the option
     */
    public BooleanConfigOption(Identifier identifier, BooleanConfigEntry config) {
     ...
     * the boolean {@link NumberConfigEntry}.
     *
